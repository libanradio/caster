...
else{e.style.width="1px",e.style.display="block",e.style.height="1px",e.style.opacity="0",t.style.width="1px",t.style.height="1px",t.style.opacity="0",t.style.display="block"
var additionalParameter='';if(typeof cstrFreePlayerCoverPhoto=="undefined"||cstrFreePlayerCoverPhoto==null){}
else
...
i.frameBorder=0,i.width="100%",i.height="170px",i.margintop="-120px",i.id="cstrFreePlayerFrame",i.scrolling="no",i.allowtransparency="true",i.setAttribute("src",s),i.setAttribute("allowtransparency","true"),document.getElementById("cstrFreePlayerDiv").appendChild(i)}};cstrBindEvent(window,"load",cstrLoadFreePlayer);
